...
\end{python}
We fall into the evaluation section. Don't get nervous, we'll get back and try \textit{k-fold} cross validation also to improve the test results. We are also planned to work with \textit{search-grid}. \newpage The evaluation results for each class is given in the following pages.
\begin{python}
Class  1                                                                                                                                                                                                                                          	           precision:  1.0                                                                                                                                                                                                                              recall:  0.6                                                                                                                                                                                                                                 fscore:  0.7499999999999999                                                                                                                                                                                                                  support:  5                                                                                                                                                                                                         
\end{python}
